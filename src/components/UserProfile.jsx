...
const UserProfile = () => {
	...
	return (
		<main className="flex flex-col items-center p-6 pb-12">
			{/* Profile Section */}
			<section className="w-full max-w-4xl p-6 text-center bg-white rounded-lg shadow-lg">
				{/* Profile Picture */}
				<div
					className="relative w-32 h-32 mx-auto mb-4 rounded-full overflow-hidden shadow-xl border-4 border-green-500 flex items-center justify-center bg-gray-200">
				...
				{/* Additional Stats */}
				<ul className="py-4 mt-6 text-gray-700 flex items-center justify-around">
					<li className="flex flex-col items-center justify-center">
						<div className="flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-r from-green-400 to-blue-500 shadow-lg ring-2 ring-white">
				...
				<ul className="p-4 space-y-4 bg-gray-50 rounded-lg shadow-md">
					{[
						...
						<li key={index}
							className="flex items-center p-4 bg-white rounded-lg shadow-sm transition-all duration-200 hover:bg-gray-200 md:flex-row flex-col">
