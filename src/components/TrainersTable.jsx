					...
					{filteredTrainers.length > 0 ? (
						filteredTrainers.map((trainer) => (
							<div
								...
								className="flex items-center bg-white border border-gray-300 rounded-xl shadow-md p-2 cursor-pointer transition-transform duration-200 hover:shadow-lg hover:scale-105 active:scale-95 w-full max-w-lg mx-auto"
							>
								{/* Profile Picture */}
