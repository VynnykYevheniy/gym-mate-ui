                    ...
                    <form action="#" autoComplete="off" className="space-y-6">
                        <div>
                            ...
                            <div className="relative mt-1 rounded-md shadow-sm">
                                ...
                                <input type="text" id="login" name="login" required className="w-full rounded-md border-gray-300 pl-10 text-sm focus:border-green-500 focus:ring-green-500" placeholder="Login" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative mt-1 rounded-md shadow-sm">
                                <div className="absolute inset-y-0 left-0 flex items-center pl-3">
                                    <svg className="h-5 w-5 text-red-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={"1.5"} stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                                    </svg>
                                </div>
                                <input type="email" id="email" name="email" className="w-full rounded-md border-red-300 pl-10 pr-10 text-sm text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500" placeholder="john@example.com" />
                        ...
                        <div>
                            ...
                            <div className="relative mt-1 rounded-md shadow-sm">
                                ...
                                <input type="password" id="password" name="password" minLength="8" className="w-full rounded-md border-gray-300 pl-10 text-sm focus:border-green-500 focus:ring-green-500" placeholder="Minimum 8 characters" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative mt-1 rounded-md shadow-sm">
                                ...
                                <input type="password" id="password_confirmation" name="password_confirmation" minLength="8" className="w-full rounded-md border-gray-300 pl-10 text-sm focus:border-green-500 focus:ring-green-500" placeholder="Minimum 8 characters" />
                            </div>
                        </div>
                        <div>
                            <a href="verify-email.html" className="flex items-center justify-center rounded-md bg-green-600 py-2 px-4 font-semibold text-white shadow-lg transition duration-150 ease-in-out hover:bg-green-700 hover:shadow-xl focus:shadow-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">Sign Up</a>
                        </div>
                    </form>

                    <div className="mt-6 flex items-center justify-center">

                        <Link className="text-sm font-medium text-green-600 hover:text-green-500" to={"/login"}> Already have an account?</Link>
                    </div>
                </div>
            </main>
        </>
