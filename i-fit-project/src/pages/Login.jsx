					...
					<form action="#" autoComplete={"off"} className="mt-6 space-y-6">
						<div>
							...
							<div className="relative mt-1 rounded-md shadow-sm">
								...
								<input type="login" id="login" name="login"
									   className="w-full rounded-md border-gray-300 pl-10 text-md focus:border-green-500 focus:ring-green-500"
									   placeholder="Login"/>
							</div>
						</div>
						...
						<div className="flex items-center justify-between">
							...
							<a href="forgot-password.html"
							   className="text-sm font-medium text-green-600 hover:text-green-500">Forgot your
								password?</a>
						</div>
