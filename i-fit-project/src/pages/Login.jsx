    ...
    <main className="flex flex-col justify-center p-6 pb-12">
      ...
      <div className="mx-auto mt-6 w-full max-w-md rounded-xl bg-white/80 p-6 shadow-xl backdrop-blur-xl sm:mt-10 sm:p-10">
        ...
        <form action="#" autocomplete="off" className="mt-6 space-y-6">
          <div>
            <label for="login" className="block text-sm font-medium text-gray-700">Login</label>
            <div className="relative mt-1 rounded-md shadow-sm">
              ...
              <input type="login" id="login" name="login" className="w-full rounded-md border-gray-300 pl-10 text-sm focus:border-green-500 focus:ring-green-500" placeholder="Login" />
            </div>
          </div>
