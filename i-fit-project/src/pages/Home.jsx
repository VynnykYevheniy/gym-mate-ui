...
//import HomeDataService from "../api/HomeDataService";
        ...
        <div className="overflow-x-auto">
          <Table hoverable>
            <Table.Head>
              ...
              <Table.HeadCell>Name Of Training</Table.HeadCell>
              <Table.HeadCell>
            ...
            <Table.Body className="divide-y">
              ...
              <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                ...
                <Table.Cell>Nogi+Ple4i</Table.Cell>
                <Table.Cell>
                  <a href="#" className="font-medium text-cyan-600 hover:underline dark:text-cyan-500">
                    Edit
                  </a>
              ...
              <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                <Table.Cell
                    className="whitespace-nowrap font-medium text-gray-900 dark:text-white">18.10.24</Table.Cell>
                <Table.Cell>Spina Gryd</Table.Cell>
                <Table.Cell>
                  <a href="#" className="font-medium text-cyan-600 hover:underline dark:text-cyan-500">
                    Edit
                  </a>
